...
if __name__ == '__main__':
    ...
    parser.add_argument('--image', help='Path to image file.', default=r'LicenseOCR\test image\bien-so-xe-may.jpg')
    ...
    if hasFrame:
        ...
        ocr = OCR(model_filename=r"LicenseOCR\src\config\attention_ocr_model.pth", use_cuda=False)
