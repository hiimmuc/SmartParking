...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.IDcard = QtWidgets.QLCDNumber(self.groupBox_2)
        self.IDcard.setGeometry(QtCore.QRect(240, 30, 351, 41))
        ...
        self.VerifyBox.setGeometry(QtCore.QRect(270, 10, 81, 60))
